...
~\newline
{\bfseries{Initializing library and getting serial descriptor in main.\+c file}} ~\newline
...
D\+ON\textquotesingle{}T F\+O\+R\+G\+ET TO D\+E\+A\+L\+L\+O\+C\+A\+TE S\+T\+R\+I\+NG A\+F\+T\+ER U\+S\+I\+NG.~\newline
 ~\newline
{\bfseries{Reading a line}} ~\newline
...
~\newline
{\bfseries{Configure serials quantity and size of the buffers}} ~\newline
